      ...
      steps {
        container('docker') {
            dir ("site") {
                ...
                sh ("docker tag ${DOCKER_HUB_ACCOUNT}/${DOCKER_IMAGE_NAME}:${env.BUILD_NUMBER} 
${DOCKER_HUB_ACCOUNT}/${DOCKER_IMAGE_NAME}:${BRANCH_NAME}-latest")
